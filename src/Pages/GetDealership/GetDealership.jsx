const GetDealership = () => {
    return (
        <div className="rounded-lg border-2 border-lime-500 p-6 bg-lime-100 space-y-8 flex flex-col">
            ...
            <button className="btn text-white bg-lime-600 hover:bg-lime-500">GET DEALERSHIP</button>
        </div>
    );
};
